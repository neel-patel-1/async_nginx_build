...
${memtier_bin} --tls --tls-skip-verify -s ${remote_mem_ip} -p 5002 -t 4 -P memcache_text --key-pattern=S:S --key-minimum=1 --key-maximum=50 --ratio=0:1 --hide-histogram --out-file tls_test.txt
